...
@section('content')
    ...
    <main>
        @if ($errors->any())
            <div class="alert alert-danger" style="margin: 70px 100px -30px 100px">
                <ul>
        ...
        <div class="content-profil row">
            ...
            <div class=col-sm-9>
                <div class="card ml-auto mr-auto">
                    <div class="card-body">
                        <form action="{{ route('profilupdate', Auth::user()->id) }}" method="POST"
                            ...
                            <button type="submit" class="btn btn-profil mx-auto mt-4" name="submit" value="submit"
                                style="float:right;">
                                Save
                            </button>
                        </form>
            ...
            <div class="col-sm-9">
                <div class="card ml-auto mr-auto">
                    <div class="card-body">
                        <form action="{{ route('profilupdatePass') }}" method="POST">
                            @method('patch')
                            @csrf
                            ...
                            <button type="submit" class="btn btn-profil" style="float:right;">
                                Save
                            </button>
                        </form>
                    </div>
